---
name: agentmail
description: "API-first email platform for AI agents (AgentMail). Use when: managing agent email inboxes, checking inbound emails, setting up email workflows/webhooks, creating new agent email addresses. DON'T use when: sending personal email as Jake (use gog/Gmail skill), reading Jake's Gmail inbox (use gog skill), or sending cold outreach sequences (use Instantly.ai)."
---
