---
name: better-notion
description: "Full CRUD for Notion pages, databases, and blocks via REST API. Use when: creating/reading/updating/deleting Notion pages, querying databases, adding blocks, searching workspace. DON'T use when: just discussing Notion concepts or planning DB structure (no API call needed). Key DB IDs in TOOLS.md. Always use API version 2025-09-03 and 'data_source_id' for database operations."
